                        ...
                        <dd class="join-form-data">                        
                                 ...
                                 <script>
                                     ...
                                     $("#day").blur(function () {
                                         ...
                                         var month = $("#month").val().trim().padStart(2, '0');
                                         var day = $("#day").val().trim().padStart(2, '0');
                                 
                                   
                                         if (year && month && day) {
                                             var birth = `\${year}-\${month}-\${day}`;
                                             $("#birth").val(birth); 
                                             // alert("생년월일: " + $("#birth").val()); 
                                         }
                                     });
                                 </script>
                        ...
                        <dt class="join-form-title">
                           취미
                              ...
                              <dd class="join-form-data habit">
                                  ...
                                  <input type="checkbox" name="habit" id="movie" value="movie" />
                                  <label for="movie">영화</label>
                                  
                                  <input type="checkbox" name="habit" id="trip" value="trip" />
